...
public class Controller2D : RaycastController
{
    ...
    private void HorizontalCollisions(ref Vector2 moveAmount)
    {
        ...
        for (int i = 0; i < horizontalRayCount; i++)
        {
            ...
            rayOrigin += new Vector2(transform.up.x, transform.up.y) * (horizontalRaySpacing * i);
    ...
    private void VerticalCollisions(ref Vector2 moveAmount)
    {
        ...
        for (int i = 0; i < verticalRayCount; i++)
        {
            ...
            rayOrigin += new Vector2(transform.right.x, transform.right.y) * (verticalRaySpacing * i + moveAmount.x);
        ...
        if (collisions.climbingSlope)
        {
            ...
            Vector2 rayOrigin = ((directionX == -1) ? raycastOrigins.bottomLeft : raycastOrigins.bottomRight) + new Vector2(transform.up.x, transform.up.y) * moveAmount.y;
            RaycastHit2D hit = Physics2D.Raycast(rayOrigin, transform.right * directionX, rayLength, collisionMask);
    ...
    private void DescendSlope(ref Vector2 moveAmount)
    {
        ...
        RaycastHit2D maxSlopeHitLeft = Physics2D.Raycast(raycastOrigins.bottomLeft, -transform.up, Mathf.Abs(moveAmount.y) + skinWidth, collisionMask);
        RaycastHit2D maxSlopeHitRight = Physics2D.Raycast(raycastOrigins.bottomRight, -transform.up, Mathf.Abs(moveAmount.y) + skinWidth, collisionMask);
